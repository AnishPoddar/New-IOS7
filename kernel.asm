...
8010373a:	68 84 75 10 80       	push   $0x80107584
...
80103ad8:	e8 53 09 00 00       	call   80104430 <release>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103af5:	e8 a6 07 00 00       	call   801042a0 <pushcli>
  c = mycpu();
80103afa:	e8 d1 fb ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103aff:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b05:	e8 d6 07 00 00       	call   801042e0 <popcli>
sched(void)
{
  int intena;
...
80103b12:	e8 39 08 00 00       	call   80104350 <holding>
...
80103b53:	e8 83 0b 00 00       	call   801046db <swtch>
  mycpu()->intena = intena;
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103bb9:	e8 e2 06 00 00       	call   801042a0 <pushcli>
  c = mycpu();
80103bbe:	e8 0d fb ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103bc3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103bc9:	e8 12 07 00 00       	call   801042e0 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
...
80103c22:	e8 59 07 00 00       	call   80104380 <acquire>
...
80103cec:	e8 8f 06 00 00       	call   80104380 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103cf1:	e8 aa 05 00 00       	call   801042a0 <pushcli>
  c = mycpu();
80103cf6:	e8 d5 f9 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103cfb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d01:	e8 da 05 00 00       	call   801042e0 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
80103d19:	e8 12 07 00 00       	call   80104430 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103d3f:	e8 5c 05 00 00       	call   801042a0 <pushcli>
  c = mycpu();
80103d44:	e8 87 f9 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103d49:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d4f:	e8 8c 05 00 00       	call   801042e0 <popcli>
void
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
80103d70:	e8 0b 06 00 00       	call   80104380 <acquire>
    release(lk);
80103d75:	89 34 24             	mov    %esi,(%esp)
80103d78:	e8 b3 06 00 00       	call   80104430 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103d9a:	e8 91 06 00 00       	call   80104430 <release>
    acquire(lk);
...
80103dab:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103dac:	e9 cf 05 00 00       	jmp    80104380 <acquire>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103df5:	e8 a6 04 00 00       	call   801042a0 <pushcli>
  c = mycpu();
80103dfa:	e8 d1 f8 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103dff:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e05:	e8 d6 04 00 00       	call   801042e0 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80103e12:	e8 69 05 00 00       	call   80104380 <acquire>
...
80103eb3:	e8 78 05 00 00       	call   80104430 <release>
        return pid;
...
80103ecc:	e8 5f 05 00 00       	call   80104430 <release>
      return -1;
...
80103eef:	e8 8c 04 00 00       	call   80104380 <acquire>
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f31:	e9 fa 04 00 00       	jmp    80104430 <release>
...
80103f84:	e8 a7 04 00 00       	call   80104430 <release>
      return 0;
...
80103fb0:	e8 7b 04 00 00       	call   80104430 <release>
  return -1;
...
80104018:	8b 14 85 ac 75 10 80 	mov    -0x7fef8a54(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
...
80104055:	e8 e6 01 00 00       	call   80104240 <getcallerpcs>
...
801040a9:	74 33                	je     801040de <cps+0x4e>
	{
		if(p->state == UNUSED)
801040ab:	8b 43 a0             	mov    -0x60(%ebx),%eax
801040ae:	85 c0                	test   %eax,%eax
801040b0:	74 ee                	je     801040a0 <cps+0x10>
      			continue;		
		cprintf("%d %s %s %d\n", p->pid, states[p->state], p->name, p->priority);
801040b2:	83 ec 0c             	sub    $0xc,%esp
801040b5:	ff 73 10             	pushl  0x10(%ebx)
801040b8:	53                   	push   %ebx
801040b9:	ff 34 85 ac 75 10 80 	pushl  -0x7fef8a54(,%eax,4)
801040c0:	83 eb 80             	sub    $0xffffff80,%ebx
801040c3:	ff b3 24 ff ff ff    	pushl  -0xdc(%ebx)
801040c9:	68 4d 75 10 80       	push   $0x8010754d
801040ce:	e8 8d c5 ff ff       	call   80100660 <cprintf>
801040d3:	83 c4 20             	add    $0x20,%esp
  	[RUNNABLE]  "runble",
  	[RUNNING]   "run   ",
  	[ZOMBIE]    "zombie"
  	};	
	...
	for(struct proc *p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040d6:	81 fb c0 4d 11 80    	cmp    $0x80114dc0,%ebx
801040dc:	75 cd                	jne    801040ab <cps+0x1b>
		if(p->state == UNUSED)
      			continue;		
		cprintf("%d %s %s %d\n", p->pid, states[p->state], p->name, p->priority);
	}
...
801040de:	b8 16 00 00 00       	mov    $0x16,%eax
...
801040fa:	68 c4 75 10 80       	push   $0x801075c4
...
80104155:	e8 d6 fb ff ff       	call   80103d30 <sleep>
...
801041b4:	e8 27 fd ff ff       	call   80103ee0 <wakeup>
  release(&lk->lk);
...
80104335:	68 e6 75 10 80       	push   $0x801075e6
...
80104342:	68 cf 75 10 80       	push   $0x801075cf
...
80104423:	68 ed 75 10 80       	push   $0x801075ed
...
8010446c:	68 f5 75 10 80       	push   $0x801075f5
...
801048c0:	68 fd 75 10 80       	push   $0x801075fd
...
801054e3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054e6:	e8 c5 e6 ff ff       	call   80103bb0 <exit>
...
{
  return wait();
801054f4:	e9 f7 e8 ff ff       	jmp    80103df0 <wait>
...
8010551e:	e8 1d ea ff ff       	call   80103f40 <kill>
...
801055ed:	e8 3e e7 ff ff       	call   80103d30 <sleep>
...
{
  return cps();
80105684:	e9 07 ea ff ff       	jmp    80104090 <cps>
